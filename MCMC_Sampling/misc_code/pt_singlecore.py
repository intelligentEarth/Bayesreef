...
class MCMC():
    ...
    def likelihood_func(self, reef, core_data, input_v):
        ...
        print(input_v, 'input_v before +++--------')

        '''input_v = np.array([ 0.00290657,  0.04083061,  0.02304713,  0.02986379,  0.04384859,
        0.04382152,  0.0401505 ,  0.04930027,  0.04663007,  0.04268071,
        0.04948789,  0.04947907,  0.15255428,  0.17904435,  0.77618653,
        0.60497876,  0.18212959,  0.93749601,  0.7675724 ,  0.83102147,
        0.99684714,  0.96931024,  0.89443512,  0.99874983, -0.05027747,
       -0.14567136,  0.1690453])'''
