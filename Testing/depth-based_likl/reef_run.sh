...
#python mcmc_adapt_gen.py -s 30000 -cs 20 -ci 10 -uc 0 -f 1
#python mcmc_adapt_gen.py -s 30000 -cs 20 -ci 10 -uc 1 -f 1 
#python mcmc_adapt_gen.py -s 50000 -cs 20 -ci 10 -uc 0 -f 1
#python mcmc_adapt_gen.py -s 50000 -cs 20 -ci 10 -uc 1 -f 1 
#python mcmc_adapt_gen.py -s 100000 -cs 20 -ci 10 -uc 0 -f 1 
