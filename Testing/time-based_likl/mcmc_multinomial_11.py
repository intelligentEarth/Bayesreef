...
class MCMC():
    ...
    def sampler(self):
        ...
        flow1[self.assemblage-1] = pos_flow1[0,self.assemblage-1] = np.random.uniform(flowlim[0], flowlim[1])
        flow2[self.assemblage-1] = pos_flow2[0,self.assemblage-1] = np.random.uniform(flow1[self.assemblage-1], flowlim[1])
        flow3[self.assemblage-1] = pos_flow3[0,self.assemblage-1] = np.random.uniform(flow2[self.assemblage-1], flowlim[1])
        flow4[self.assemblage-1] = pos_flow4[0,self.assemblage-1] = np.random.uniform(flow3[self.assemblage-1], flowlim[1])

        sed1[self.assemblage-1] = pos_sed1[0,self.assemblage-1] = np.random.uniform(sedlim[0], sedlim[1])
        sed2[self.assemblage-1] = pos_sed2[0,self.assemblage-1] = np.random.uniform(sed1[self.assemblage-1], sedlim[1])
        sed3[self.assemblage-1] = pos_sed3[0,self.assemblage-1] = np.random.uniform(sed2[self.assemblage-1], sedlim[1])
        sed4[self.assemblage-1] = pos_sed4[0,self.assemblage-1] = np.random.uniform(sed3[self.assemblage-1], sedlim[1])
        ...
        for i in range(samples - 1):
            ...
            p_sed1[self.assemblage-1] = self.proposalJump(sed1[self.assemblage-1],sedlim[0],sedlim[1], self.step_sed) 
            p_sed2[self.assemblage-1] = self.proposalJump(sed2[self.assemblage-1],sed1[self.assemblage-1], sedlim[1], self.step_sed)
            p_sed3[self.assemblage-1] = self.proposalJump(sed3[self.assemblage-1],sed2[self.assemblage-1], sedlim[1], self.step_sed) 
            p_sed4[self.assemblage-1] = self.proposalJump(sed4[self.assemblage-1],sed3[self.assemblage-1], sedlim[1], self.step_sed)
...
def main():
    ...
    description = 'Time-based likelihood. self.likelihoodWithProps'
    assemblage = 2
